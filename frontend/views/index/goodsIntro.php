        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="/index/search" name="serarch" method="get" class="fl">
                    <input type="text" class="txt" name="keys" value="" /><input type="submit" class="btn" value="搜索" />
                </form>
...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="<?=\yii\helpers\Url::to(["/index/goods-list","id"=>$oneCategory->id])?>"><?=$oneCategory->name?></a> > <a href="<?=\yii\helpers\Url::to(["/index/goods-list","id"=>$twoCategory->id])?>"><?=$twoCategory->name?></a> > <a href="<?=\yii\helpers\Url::to(["/index/goods-list","id"=>$threeCategory->id])?>"><?=$threeCategory->name?></a> > <?=$goodsMessage->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <h3><strong><?=$goodsMessage->name?></strong></h3>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <li><span>商品编号： </span><?=$goodsMessage->sn?></li>
        ...
        <div class="detail">
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            <li><span>商品名称：</span><?=$goodsMessage->name?></li>
                            <li><span>商品编号：</span><?=$goodsMessage->sn?></li>
                            <li><span>品牌：</span><?=$goodsMessage->brand->name?></li>
                            <li><span>上架时间：</span><?=date("Y-m-d H:i:s",$goodsMessage->create_time)?></li>
                            <li><span>商品毛重：</span>未知</li>
                            <li><span>商品产地：</span>未知</li>
                            <li><span>显卡：</span>未知</li>
                            <li><span>触控：</span>未知</li>
                            <li><span>厚度：</span>未知</li>
                            <li><span>处理器：</span>未知</li>
                            <li><span>尺寸：</span>未知</li>
                        </ul>
                    </div>
...
<script type="text/javascript">
    ...
    /**
     * 此文件作为页面静态化的模版,需要通过Ajax获取用户的登录信息
     */
